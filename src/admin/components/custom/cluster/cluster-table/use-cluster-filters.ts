...
type ClusterFilterAction =
  ...
  | { type: "setFilters"; payload: ClusterFilterState }
  | { type: "reset"; payload: ClusterFilterState }
  | { type: "setOffset"; payload: number }
  | { type: "setDefaults"; payload: ClusterDefaultFilters | null }
...
export const useClusterFilters = (
  ...
  const getQueryString = () => {
    ...
    console.log("Who the fuck am i?", obj)
