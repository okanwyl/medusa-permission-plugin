...
import {clusterDetailsSchema, ClusterDetailsForm } from "../forms/cluster-details-form";
import {
    ClusterUsersForm,
    clusterUsersSchema
            ...
            await handleSubmit(async (data) => {
                ...
                userIds.forEach((payloadId) => {
                    ...
                    const res = await prompt({
                        title: "Are you sure?",
                        description: "You are going to create a cluster and this action will give selected users the selected permissions."
                    })
