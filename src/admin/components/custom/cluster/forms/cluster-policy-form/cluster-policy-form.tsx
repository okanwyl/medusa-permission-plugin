...
import {PolicyFilter, PolicyFilterMenu} from "../../../policy/policy-filter-menu"
...
const ClusterPolicyForm = ({
                               form,
                               policies,
                           }: ClusterPolicyFormProp) => {
    const {
        register,
        path,
        setValue,
    ...
    const {policy, count, isLoading, isRefetching} = useAdminPolicy(
        {
            limit: PAGE_SIZE,
            offset,
            q: debouncedQuery,
