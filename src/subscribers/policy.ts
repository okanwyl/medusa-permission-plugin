...
export default class MySubscriber {
    ...
    constructor(
        ...
        eventBusService.subscribe(PolicyService.Events.CREATED, this.handleHashmapCache);
        eventBusService.subscribe(PolicyService.Events.DELETED, this.handleHashmapCache);
        eventBusService.subscribe(PolicyService.Events.UPDATED, this.handleHashmapCache);
        eventBusService.subscribe(PolicyClusterService.Events.CREATED, this.handleHashmapCache);
        eventBusService.subscribe(PolicyClusterService.Events.UPDATED, this.handleHashmapCache);
        eventBusService.subscribe(PolicyClusterService.Events.DELETED, this.handleHashmapCache);
